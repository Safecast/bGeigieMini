 ...
 */
uintptr_t SDCardManager_WriteBlockHandler(USB_ClassInfo_MS_Device_t* const MSInterfaceInfo, uint8_t* buffer, offset_t offset, void* p)
{
...
void SDCardManager_WriteBlocks(USB_ClassInfo_MS_Device_t* const MSInterfaceInfo, uint32_t BlockAddress, uint16_t TotalBlocks)
{
	...
	while (TotalBlocks)
	{
		sd_raw_write_interval(MSInterfaceInfo, BlockAddress *  VIRTUAL_MEMORY_BLOCK_SIZE, Buffer, VIRTUAL_MEMORY_BLOCK_SIZE, &SDCardManager_WriteBlockHandler, NULL);
...
uint8_t SDCardManager_ReadBlockHandler(USB_ClassInfo_MS_Device_t* const MSInterfaceInfo, uint8_t* buffer, offset_t offset, void* p)
{
	//uint8_t i;
...
void SDCardManager_ReadBlocks(USB_ClassInfo_MS_Device_t* const MSInterfaceInfo, uint32_t BlockAddress, uint16_t TotalBlocks)
{
	...
	while (TotalBlocks)
	{
		...
		sd_raw_read_interval(MSInterfaceInfo, BlockAddress * VIRTUAL_MEMORY_BLOCK_SIZE, Buffer, 16, 512, &SDCardManager_ReadBlockHandler, NULL);
